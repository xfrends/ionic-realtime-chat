...
/* harmony import */ var _index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-2b53f989.js */ 4243);
...
const Nav = class {
  ...
  disconnectedCallback() {
    for (const view of this.views) {
      (0,_index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__.d);
      ...
      viewIsReady: enteringEl => {
        ...
        resolve({
          ...
          markVisible: function () {
            var _ref = (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
              mark();
              yield finish;
            });
  ...
  postViewInit(enteringView, leavingView, ti) {
    ...
    if (destroyQueue && destroyQueue.length > 0) {
      for (const view of destroyQueue) {
        (0,_index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__.b);
        (0,_index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__.c);
        (0,_index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__.l)(view.element, _index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__.d);
  ...
  transition(enteringView, leavingView, ti) {
    ...
    return (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const {
        hasCompleted
      } = yield (0,_index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__.t)(animationOpts);
    ...
    for (let i = views.length - 1; i >= 0; i--) {
      ...
      if (element) {
        if (i > activeViewIndex) {
          ...
          // let's unload it
          (0,_index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__.l)(element, _index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__.d);
          this.destroyView(view);
        } else if (i < activeViewIndex) {
          // this view comes before the active view
          // and it is not a portal then ensure it is hidden
          (0,_index_2b53f989_js__WEBPACK_IMPORTED_MODULE_5__.s)(element, true);
        }
      }
    }
  }
