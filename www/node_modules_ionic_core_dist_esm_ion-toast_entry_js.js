...
/* harmony import */ var _overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./overlays-fd4e69d9.js */ 877);
...
const Toast = class {
  constructor(hostRef) {
    ...
    this.dispatchCancelHandler = ev => {
      ...
      if ((0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_3__.i)(role)) {
  ...
  connectedCallback() {
    (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_3__.e)(this.el);
  }
  /**
  ...
  present() {
    ...
    return (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_3__.d)(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, _this.position);
  ...
  dismiss(data, role) {
    ...
    return (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_3__.f)(this, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation, this.position);
  }
  /**
  ...
  onDidDismiss() {
    return (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionToastDidDismiss');
  }
  /**
  ...
  onWillDismiss() {
    return (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionToastWillDismiss');
  }
  ...
  callButtonHandler(button) {
    return (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        try {
          const rtn = yield (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_3__.s)(button.handler);
