...
const Loading = class {
  ...
  present() {
    ...
    return (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_3__.d)(_this, 'loadingEnter', iosEnterAnimation, mdEnterAnimation, undefined);
  ...
  dismiss(data, role) {
    ...
    return (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_3__.f)(this, data, role, 'loadingLeave', iosLeaveAnimation, mdLeaveAnimation);
  }
  /**
  ...
  onDidDismiss() {
    return (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionLoadingDidDismiss');
  }
  /**
  ...
  onWillDismiss() {
    return (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el, 'ionLoadingWillDismiss');
  }
