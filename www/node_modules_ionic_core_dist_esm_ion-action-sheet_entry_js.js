...
/* harmony import */ var _overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./overlays-fd4e69d9.js */ 877);
...
const ActionSheet = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_4__.B);
    };

    this.dispatchCancelHandler = ev => {
      const role = ev.detail.role;

      if ((0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_4__.i)(role)) {
  ...
  present() {
    return (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_4__.d)(this, 'actionSheetEnter', iosEnterAnimation, mdEnterAnimation);
  }

  connectedCallback() {
    (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_4__.e)(this.el);
  }
  /**
  ...
  dismiss(data, role) {
    return (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_4__.f)(this, data, role, 'actionSheetLeave', iosLeaveAnimation, mdLeaveAnimation);
  }
  /**
  ...
  onDidDismiss() {
    return (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionActionSheetDidDismiss');
  }
  /**
  ...
  onWillDismiss() {
    return (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_4__.g)(this.el, 'ionActionSheetWillDismiss');
  }
  ...
  callButtonHandler(button) {
    return (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button) {
        ...
        const rtn = yield (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_4__.s)(button.handler);
