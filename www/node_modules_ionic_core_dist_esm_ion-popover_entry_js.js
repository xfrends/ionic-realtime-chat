...
/* harmony import */ var _overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./overlays-fd4e69d9.js */ 877);
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_5__.B);
    };
  ...
  connectedCallback() {
    (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_5__.e)(this.el);
  }
  ...
  present(event) {
    ...
    return (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.currentTransition = (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_5__.d)(_this2, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      if (_this2.focusDescendantOnPresent) {
        (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_5__.j)(_this2.el, _this2.el);
      }
    })();
  }
  /**
  ...
  dismiss(data, role, dismissParentPopover = true) {
    ...
    return (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this3.currentTransition = (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this3, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, _this3.event);
  ...
  onDidDismiss() {
    return (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_5__.g)(this.el, 'ionPopoverDidDismiss');
  }
  /**
  ...
  onWillDismiss() {
    return (0,_overlays_fd4e69d9_js__WEBPACK_IMPORTED_MODULE_5__.g)(this.el, 'ionPopoverWillDismiss');
  }
