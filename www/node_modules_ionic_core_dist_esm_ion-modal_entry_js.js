...
/* harmony import */ var _index_7cd5eefa_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index-7cd5eefa.js */ 9081);
...
/* harmony import */ var _overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./overlays-ff47fddd.js */ 6523);
/* harmony import */ var _theme_7670341c_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./theme-7670341c.js */ 320);
/* harmony import */ var _index_2b53f989_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./index-2b53f989.js */ 4243);
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref = (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
...
const createSwipeToCloseGesture = (el, contentEl, scrollEl, animation, onDismiss) => {
  ...
  const getScrollY = () => {
    if ((0,_index_7cd5eefa_js__WEBPACK_IMPORTED_MODULE_3__.i)(contentEl)) {
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_8__.B);
    };
  ...
  swipeToCloseChanged(enable) {
    ...
    return (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this.gesture) {
  ...
  connectedCallback() {
    (0,_overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_8__.e)(this.el);
  }
  ...
  present() {
    ...
    return (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield (0,_index_2b53f989_js__WEBPACK_IMPORTED_MODULE_10__.e)(_this3.usersElement);
      (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.c)(() => _this3.el.classList.add('show-modal'));
      _this3.currentTransition = (0,_overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_8__.d)(_this3, 'modalEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      } else if (_this3.swipeToClose || _this3.canDismiss !== undefined && _this3.presentingElement !== undefined) {
  ...
  initSwipeToClose() {
    ...
    return (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if ((0,_ionic_global_f1ce4d2d_js__WEBPACK_IMPORTED_MODULE_2__.b)(_this4) !== 'ios') {
        return;
      }

      const {
        el
      } = _this4; // All of the elements needed for the swipe gesture
      // should be in the DOM and referenced by now, except
      // for the presenting el

      const animationBuilder = _this4.leaveAnimation || _ionic_global_f1ce4d2d_js__WEBPACK_IMPORTED_MODULE_2__.c.get('modalLeave', iosLeaveAnimation);
      const ani = _this4.animation = animationBuilder(el, {
        presentingEl: _this4.presentingElement
      });
      const contentEl = (0,_index_7cd5eefa_js__WEBPACK_IMPORTED_MODULE_3__.f)(el);

      if (!contentEl) {
        (0,_index_7cd5eefa_js__WEBPACK_IMPORTED_MODULE_3__.p)(el);
        return;
      }

      const scrollEl = yield (0,_index_7cd5eefa_js__WEBPACK_IMPORTED_MODULE_3__.g)(contentEl);
      _this4.gesture = createSwipeToCloseGesture(el, contentEl, scrollEl, ani, () => {
        /**
        ...
        _this4.animation.onFinish( /*#__PURE__*/(0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  sheetOnDismiss() {
    ...
    this.animation.onFinish( /*#__PURE__*/(0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const enteringAnimation = _overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_8__.h.get(_this6) || [];
      _this6.currentTransition = (0,_overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_8__.f)(_this6, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, {
      ...
      if (dismissed) {
        ...
        (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.c)(() => _this6.el.classList.remove('show-modal'));
  ...
  onDidDismiss() {
    return (0,_overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_8__.g)(this.el, 'ionModalDidDismiss');
  }
  /**
  ...
  onWillDismiss() {
    return (0,_overlays_ff47fddd_js__WEBPACK_IMPORTED_MODULE_8__.g)(this.el, 'ionModalWillDismiss');
  }
  /**
