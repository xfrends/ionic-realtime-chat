...
const InfiniteScroll = class {
  ...
  connectedCallback() {
    ...
    return (0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const contentEl = (0,_index_7cd5eefa_js__WEBPACK_IMPORTED_MODULE_3__.a)(_this.el);

      if (!contentEl) {
        (0,_index_7cd5eefa_js__WEBPACK_IMPORTED_MODULE_3__.p)(_this.el);
        return;
      }

      _this.scrollEl = yield (0,_index_7cd5eefa_js__WEBPACK_IMPORTED_MODULE_3__.g)(contentEl);
