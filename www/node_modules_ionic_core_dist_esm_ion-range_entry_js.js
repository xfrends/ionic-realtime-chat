...
const Range = class {
  constructor(hostRef) {
    ...
    this.clampBounds = value => {
      return (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_3__.l)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,_Users_frenditriarista_MobileApps_ionic_realtime_chat_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_3__.l)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_3__.l)(0, this.ratioB + step, 1);
      }
  ...
  onStart(detail) {
    ...
    let ratio = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_3__.l)(0, (currentX - rect.left) / rect.width, 1);
  ...
  render() {
    ...
    let {
      labelText
    } = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_3__.d)(el, rangeId);
    ...
    (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_3__.e)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  return (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_3__.l)(min, value, max);
};

const valueToRatio = (value, min, max) => {
  return (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_3__.l)(0, (value - min) / (max - min), 1);
};
